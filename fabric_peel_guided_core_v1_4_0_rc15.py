...
def write_run_report(
    ...
    <hr style="margin-top:28px;border:0;border-top:1px solid #d9e1e5;">
    <div style="font-size:12px;color:#607d8b;line-height:1.5;margin-top:10px;">
      <b>Generated by:</b> Peel Trace Evaluation for Soft Substrates v1.4.0-rc15.<br>
      Tang Lab / VCU Soft Functional Materials Lab, Department of Chemical and Life Science Engineering, Virginia Commonwealth University.<br>
      <b>Repository:</b>
      <a href="https://github.com/VCU-Soft-Functional-Materials-Lab/Peel-Trace-Evaluation-for-Soft-Substrates">
        https://github.com/VCU-Soft-Functional-Materials-Lab/Peel-Trace-Evaluation-for-Soft-Substrates
      </a><br>
      <b>Use note:</b> This report summarizes one processed analysis run. Reproducibility-critical details are stored in the exported metrics, diagnostics, output-consistency audit, method-profile record, and provenance file.<br>
      <b>Interpretation boundary:</b> Reported values are protocol-defined peel-trace descriptors, not intrinsic adhesive material constants.
    </div>
    </div>
    </body></html>"""
    ...
    md_lines = [
        ...
        "This report summarizes one processed analysis run. Reproducibility-critical details are stored in the exported metrics, diagnostics, output-consistency audit, method-profile record, and provenance file.",
        "",
        "## Interpretation note",
        "Manuscript-baseline outputs are protocol-defined descriptors under the specified test geometry and analysis settings. They are not intrinsic adhesive material constants. NON_MANUSCRIPT_MODIFIED runs are recovery/sensitivity outputs and should not be mixed with manuscript-baseline outputs without explicit disclosure.",
        "",
        "## Attribution",
        "Generated by Peel Trace Evaluation for Soft Substrates v1.4.0-rc15.",
        "Tang Lab / VCU Soft Functional Materials Lab, Department of Chemical and Life Science Engineering, Virginia Commonwealth University.",
        "",
        "Repository: https://github.com/VCU-Soft-Functional-Materials-Lab/Peel-Trace-Evaluation-for-Soft-Substrates",
    ]
